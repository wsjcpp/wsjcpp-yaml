...
UnitTestReadYaml::UnitTestReadYaml() : WsjcppUnitTestBase("UnitTestReadYaml") {}
...
void UnitTestReadYaml::executeTest() {
  ...
  // services.db
  {
    ...
    compare("services.db.environment.POSTGRES_USER", pDbEnvironment->getElement("POSTGRES_USER")->getValue(),
            "postgres");

    compare("has services.db.environment.POSTGRES_PASSWORD", pDbEnvironment->hasElement("POSTGRES_PASSWORD"), true);
    compare("services.db.environment.POSTGRES_PASSWORD", pDbEnvironment->getElement("POSTGRES_PASSWORD")->getValue(),
            "postgres");
