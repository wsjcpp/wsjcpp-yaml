...
UnitTestCursor::UnitTestCursor() : WsjcppUnitTestBase("UnitTestCursor") {}
...
void UnitTestCursor::executeTest() {
  ...
  compare("map1.map11.map111.param1111 is undefined", yaml["map1"]["map11"]["map111"]["param1111"].isUndefined(),
          false);
