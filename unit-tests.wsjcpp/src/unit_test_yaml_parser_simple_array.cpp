...
UnitTestYamlParserSimpleArray::UnitTestYamlParserSimpleArray() : WsjcppUnitTestBase("UnitTestYamlParserSimpleArray") {
  //
}
...
void UnitTestYamlParserSimpleArray::executeTest() {
  ...
  compare("param1-line", yaml.getRoot()->getElement("param1")->getPlaceInFile().getLine(),
          "param1: none value1 # it's value for something # olala  ");
  compare("param1-original-number-of-line", yaml.getRoot()->getElement("param1")->getPlaceInFile().getNumberOfLine(),
          1);
  ...
  compare("array-test2-element2-line",
          yaml.getRoot()->getElement("array-test2")->getElement(2)->getPlaceInFile().getLine(),
          "  - true # comment true ");
  compare("array-test2-element2-original-number-of-line",
          yaml.getRoot()->getElement("array-test2")->getElement(2)->getPlaceInFile().getNumberOfLine(), 5);
  compare("array-test2-element2-comment", yaml.getRoot()->getElement("array-test2")->getElement(2)->getComment(),
          "comment true");

  compare("array-test2-element3-value", yaml.getRoot()->getElement("array-test2")->getElement(3)->getValue(),
          "falsesome");
  compare("array-test2-element3-line",
          yaml.getRoot()->getElement("array-test2")->getElement(3)->getPlaceInFile().getLine(), "  - falsesome   ");
  compare("array-test2-element3-original-number-of-line",
          yaml.getRoot()->getElement("array-test2")->getElement(3)->getPlaceInFile().getNumberOfLine(), 7);
  compare("array-test2-element3-comment", yaml.getRoot()->getElement("array-test2")->getElement(3)->getComment(), "");

  compare("array-test2-element4-value", yaml.getRoot()->getElement("array-test2")->getElement(4)->getValue(),
          "free@free");
  compare("array-test2-element4-line",
          yaml.getRoot()->getElement("array-test2")->getElement(4)->getPlaceInFile().getLine(), "  - free@free   ");
  compare("array-test2-element4-original-number-of-line",
          yaml.getRoot()->getElement("array-test2")->getElement(4)->getPlaceInFile().getNumberOfLine(), 8);
  ...
  compare("array-test2-element5-line",
          yaml.getRoot()->getElement("array-test2")->getElement(5)->getPlaceInFile().getLine(), "  - # empty ");
  compare("array-test2-element5-original-number-of-line",
          yaml.getRoot()->getElement("array-test2")->getElement(5)->getPlaceInFile().getNumberOfLine(), 9);
  compare("array-test2-element5-comment", yaml.getRoot()->getElement("array-test2")->getElement(5)->getComment(),
          "empty");

  compare("array-test2-element6-value", yaml.getRoot()->getElement("array-test2")->getElement(6)->getValue(), "1");
  compare("array-test2-element6-line",
          yaml.getRoot()->getElement("array-test2")->getElement(6)->getPlaceInFile().getLine(), "  - 1");
  compare("array-test2-element6-original-number-of-line",
          yaml.getRoot()->getElement("array-test2")->getElement(6)->getPlaceInFile().getNumberOfLine(), 10);
  ...
  compare("param2-original-number-of-line", yaml.getRoot()->getElement("param2")->getPlaceInFile().getNumberOfLine(),
          11);
