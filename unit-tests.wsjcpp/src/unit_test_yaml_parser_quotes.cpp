...
UnitTestYamlParserQuotes::UnitTestYamlParserQuotes() : WsjcppUnitTestBase("UnitTestYamlParserQuotes") {
  //
}
...
void UnitTestYamlParserQuotes::executeTest() {
  ...
  compare("issues-value", yaml.getRoot()->getElement("issues")->getValue(),
          "https://github.com/wsjcpp/wsjcpp-yaml/issues");
  compare("empty-value", yaml.getRoot()->getElement("empty")->getValue(), "");

  compare("array-element0-value", yaml.getRoot()->getElement("array")->getElement(0)->getValue(),
          "https://github.com/wsjcpp/wsjcpp-core:v0.0.1");
