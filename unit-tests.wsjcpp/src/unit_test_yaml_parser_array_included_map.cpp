...
void UnitTestYamlParserArrayIncludedMap::executeTest() {
  ...
  std::string sTestYaml = "#test array included map\n"
  ...
  compare("array-test2-element1-value", yaml.getRoot()->getElement("array-test2")->getElement(1)->getValue(),
          "value22");
  compare("array-test2-element1-comment", yaml.getRoot()->getElement("array-test2")->getElement(1)->getComment(),
          "comment v22");
