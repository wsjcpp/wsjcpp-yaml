...
enum WsjcppYamlQuotes { WSJCPP_YAML_QUOTES_NONE, WSJCPP_YAML_QUOTES_DOUBLE, WSJCPP_YAML_QUOTES_SINGLE };
...
public:
  WsjcppYamlNode(WsjcppYamlNode *pParent, IWsjcppYamlLog *pLog, const WsjcppYamlPlaceInFile &placeInFile,
  ...
  bool setElementValue(const std::string &sName, const std::string &sValue,
